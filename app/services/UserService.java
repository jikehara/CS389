...
public interface UserService {
	/**
	 * Checks a user to see if it is null or matches the username of a different
	 * user. Will persist a new user to the entity manager
	 * 
	 * @param user
	...
	/**
	 * Find a user with this username and return the userinfo, or return null if no
	 * matching username can be found
	 * 
	 * @param username
